...
<head>
    ...
    <title>Absensi Anugrah Mandiri Teknik</title>
...
<body>
    <div class="wrapper">
        <div class="sidebar" data-image="../assets/img/sidebar-5.jpg" data-color="azure">
            <!--
                ...
                <div class="container">
                    <nav>
                        <p class="copyright text-center">
                            &copy; 2021 <a href="http://indoexpress.co.id">PT. Anugrah Mandiri Teknik</a>
                        </p>
                    </nav>
                </div>
            </footer>
